...
def main():
    ...
    PROGRAM_COLUMNS = ["id", "name", "cycle", "url", "courses", "courses_ects"]
    print(programs_and_courses_data[PROGRAM_COLUMNS])
    ...
    new_columns = [col.removeprefix('courses_') for col in COURSES_COLUMNS]
